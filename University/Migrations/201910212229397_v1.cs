    ...
    public partial class v1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        IntructorID = c.Int(nullable: false),
                        Location = c.String(maxLength: 50),
                    })
                .PrimaryKey(t => t.IntructorID)
                .ForeignKey("dbo.People", t => t.IntructorID)
                .Index(t => t.IntructorID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OfficeAssignments", "IntructorID", "dbo.People");
            ...
            DropIndex("dbo.OfficeAssignments", new[] { "IntructorID" });
